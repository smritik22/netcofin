            ...
            <div class="row">
                <div class="col-12">
                    <div class="agent-propties-heading">
                        <h2>{{$labels['property_listing']}} @if($total_properties > $list_limit) <a href="{{route('frontend.propertylist', ['id' => 'agent_properties']) . '?' . http_build_query(['agent' => encrypt($agent->id)])}}">{{$labels['view_all']}}</a> @endif</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="agent-btn">
                        @if($user_id == $agent->id)
                            <a class="comman-btn" href="{{route('frontend.account')}}">{{$labels['my_account']}}</a>
                        @else
                            <a class="comman-btn" href="{{route('frontend.conversation.list', ['id' => encrypt($agent->id)])}}">{{$labels['send_a_message']}}</a>
                        @endif
                    </div>
                </div>
            </div>
