<div class="col-lg-3">
    ...
    <div class="filter-box-outer">
            ...
            <div class="accordion" id="bedroomTypeaccordion">
                <div class="accordion-item border-0">
                    ...
                    <div id="collapseBedrooms" class="accordion-collapse collapse " aria-labelledby="headingBedrooms"
                        ...
                        <div class="accordion-body p-0">
                            <select name="bedroom_count" id="bedroom_count" class="form-control">
                                <option value="">{{$labels['bedroom_numbers']}}</option>
            ...
            <div class="accordion" id="bathroomTypeaccordion">
                <div class="accordion-item border-0">
                    ...
                    <div id="collapseBathrooms" class="accordion-collapse collapse" aria-labelledby="headingBathrooms"
                        ...
                        <div class="accordion-body p-0">
                            <select name="bathroom_count" id="bathroom_count" class="form-control">
                                <option value="">{{$labels['bathroom_numbers']}}</option>
        ...
        <div class="filter-box">
            <div class="accordion" id="propertyToiletsAccordion">
                <div class="accordion-item border-0">
                    <h2 class="accordion-header" id="headingToiletsqft">
                        <button class="accordion-button collapsed p-0" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseToilets" aria-expanded="true" aria-controls="collapseToilets">
                            {{ $labels['toilet_numbers'] }}
                        </button>
                    </h2>
                    <div id="collapseToilets" class="accordion-collapse collapse" aria-labelledby="headingToiletsqft"
                        data-bs-parent="#propertyToiletsAccordion">
                        <div class="accordion-body p-0">
                            <select name="toilet_count" id="toilet_count" class="form-control">
                                <option value="">{{$labels['toilet_numbers']}}</option>
        ...
        <div class="mobile-btn-apply d-lg-none">
            ...
            <a href="#" onclick="applyFilter(this,event);" class="fillter-close">{{ $labels['apply'] }}</a>
        </div>
    </div>
</div>
