        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb ">
                        <ol class="breadcrumb mb-0">
                            ...
                            @else    
                                ...
                                @if ($agent_details)
                                <li class="breadcrumb-item active" aria-current="page" ><img
                                    src="{{ asset('assets/img/bread.svg') }}" alt="icon" />{{urldecode($agent_details->full_name) }}</li>
                                @endif
                            @endif
                        </ol>
                    </nav>
                    ...
                    <input type="hidden" name="s_property_type" value="{{$property_type}}" id="s_property_type">
                    <input type="hidden" name="s_property_for" value="{{$property_for}}" id="s_property_for">
                    <input type="hidden" name="s_search" value="{{$search}}" id="s_search">
                    <input type="hidden" name="is_search" value="{{$is_search}}" id="is_search">
...
@push('after-scripts')
    ...
    <script>
        ...
        function loadData(list_type = null, page_no = null) {
            ...
            let bedroom_number = $('#bedroom_count').val();
            let bathroom_number = $('#bathroom_count').val();
            let toilet_number = $('#toilet_count').val();
        ...
        $(document).ready(function() {
            ...
            $('#bedroom_count, #bathroom_count, #toilet_count').on('change', function(e) {
                e.preventDefault();
                loadData();
                if($('.list-view.active').data('list_type') == 2) {
                    initialize();
    ...
    <script>
        ...
        function initialize(ready=false) {
            ...
            var image = "{{ asset('assets/img/map-view.png') }}";
                    ...
                    success: function(data_one) {
                        if (typeof data_one == 'object') {
                            ...
                            for (var i in LocationData) {
                                ...
                                if(i == (LocationData.length - 1) && isInitial == 1) {
