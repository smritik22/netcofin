                                                ...
                                                @foreach ($subscription_plans as $key => $plan)    
                                                    <div class="active-plan-box {{$key > 0 ? 'mt-md-5 mt-4' : ''}}">
                                                        ...
                                                        @php
                                                            ...
                                                            $now = new DateTime();
                                                            $total_days = $end_date->diff($start_date)->format("%a");
                                                            $curr_days = $end_date->diff($now)->format("%a");
                                                            $progress = ($curr_days * 100)/$total_days;
                                                        @endphp
                                                        <div class="progress">
                                                            <div class="progress-bar" style="width:{{$progress}}%" role="progressbar" aria-valuenow="{{$progress}}"
