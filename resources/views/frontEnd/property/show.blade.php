            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="property-detail-left">
                        ...
                        @php
                            $property_price = (@\Auth::guard('web')->check() && \Auth::guard('web')->id() == $property->agent_id && env('BASE_PRICE_FOR_AGENT') == 1) ? $property->base_price : $property->price_area_wise;
                        @endphp
                        ...
                        <div class="edit-detail-box">
                            ...
                            <form action="#" id="report_user_form" name="report_user_form" method="post" enctype="multipart/form-data">
                                <div class="input-outer">
                                    ...
                                    <input type="text" id="r_name" name="r_name" value="{{@Auth::guard('web')->check() ? urldecode(Auth::guard('web')->user()->full_name) : ''}}" maxlength="200" placeholder="{{$labels['enter_name']}}" data-error="#r_name_error" required>
                                ...
                                <div class="input-outer">
                                    ...
                                    <div class="mobile-number-code">
                                        <input type="number" id="r_mobile" name="r_mobile" value="{{@Auth::guard('web')->check() ? Auth::guard('web')->user()->mobile_number : ''}}" maxlength="15" placeholder="{{$labels['mobile_number']}}" data-error="#r_mobile_error">
