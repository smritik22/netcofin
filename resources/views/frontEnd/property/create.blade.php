                    ...
                    <nav aria-label="breadcrumb ">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><img
                                    ...
                                    alt="icon" />{{ @$property ? $labels['edit_property'] : $labels['add_new_property'] }}
                            </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <ul class="nav " id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="addproperty-tab" data-bs-toggle="tab"
                                    ...
                                    {{ @$property ? $labels['edit_property'] : $labels['add_property'] }}</button>
                            </li>
                            @if (!@$property)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="selectplan-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false" @if (!$property) disabled @endif>2.
                                        {{ $labels['select_plan'] }} </button>
                                </li>
                            @endif
                        </ul>
                                    ...
                                    <div class="add-new-property-field">
                                        <div class="row">
                                                ...
                                                <div class="add-property-field">
                                                    <div class="">
                                                        ...
                                                        <input type="text" class="form-control" id="property_title"
                                                            name="property_title" data-error="#property_title_error"
                                                        ...
                                                        @foreach (config('constants.PROPERTY_FOR') as $item)
                                                            <div class="col-6">
                                                                <div class="form-check form-check-inline me-0 ps-0">
                                                                    <label
                                                                        class="form-check-label {{ @$property->property_for == $item['value'] ? 'checked1' : '' }}"
                                                                        ...
                                                                        <input class="form-check-input" type="radio"
                                                                            ...
                                                                            value="{{ $item['value'] }}"
                                                                            @checked(@$property->property_for == $item['value'] ? true : false)>
                                                                        <span
                                                        ...
                                                        <select name="property_type" id="property_type"
                                                            ...
                                                            @foreach ($property_types as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @selected(@$property->property_type == $item->id ? true : false)>
                                                ...
                                                <div class="add-property-field">
                                                    <div class="">
                                                        ...
                                                        <input type="number" name="area_sqft" class="form-control"
                                                            ...
                                                            placeholder="{{ $labels['enter_area'] }}"
                                                            value="{{ @$property->property_sqft_area ?: '' }}">
                                                    </div>
                                                            ...
                                                            <div class="add-property-field-select">
                                                                <select name="bedroom_type" data-error="#bedroom_type_error"
                                                                    ...
                                                                    @foreach ($bedroom_types as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            @selected(@$property->bedroom_type == $item->id ? true : false)>
                                                                            {{ $language_id != 1 && @$item->childdata[0]->type ? $item->childdata[0]->type : $item->type }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="add-property-field-select">
                                                                <select name="total_bedroom" id="total_bedroom"
                                                                    ...
                                                                    @for ($i = 1; $i <= \Helper::getMaxBedroomNumbers(); $i++)
                                                                        <option value="{{ $i }}"
                                                                            @selected(@$property->total_bedrooms == $i ? true : false)>
                                                                            {{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="add-property-field-select">
                                                                <select name="bathroom_type" id="bathroom_type"
                                                                    ...
                                                                    @foreach ($bathroom_types as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            @selected(@$property->bathroom_type == $item->id ? true : false)>
                                                                            {{ $language_id != 1 && @$item->childdata[0]->type ? $item->childdata[0]->type : $item->type }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="add-property-field-select">
                                                                <select name="total_bathroom" id="total_bathroom"
                                                                    ...
                                                                    @for ($i = 1; $i <= \Helper::getMaxBathroomNumbers(); $i++)
                                                                        <option value="{{ $i }}"
                                                                            @selected(@$property->total_bathrooms == $i ? true : false)>
                                                                            {{ $i }}</option>
                                                                    @endfor
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="add-property-field-select">
                                                        <select name="total_toilets" id="total_toilets"
                                                            ...
                                                            @for ($i = 1; $i <= \Helper::getMaxToiletNumbers(); $i++)
                                                                <option value="{{ $i }}"
                                                                    @selected(@$property->total_toilets == $i ? true : false)>{{ $i }}
                                                                </option>
                                                            @endfor
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="add-property-field">
                                                    <label for="condition"
                                                        class="form-label">{{ $labels['condition'] }}</label>
                                                    <div class="add-property-field-select">
                                                        <select name="condition" id="condition"
                                                            data-error="#condition_error">
                                                            <option value="">{{$labels['select_condition']}}</option>
                                                            @foreach ($condition_types as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @selected(@$property->condition_type_id == $item->id ? true : false)>
                                                                    {{ $language_id != 1 && @$item->childdata[0]->condition_text ? $item->childdata[0]->condition_text : $item->condition_text }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <span id="condition_error" class="error-login"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="add-property-field">
                                                    <label for="completion_status"
                                                        class="form-label">{{ $labels['completion_status'] }}</label>
                                                    <div class="add-property-field-select">
                                                        <select name="completion_status" id="completion_status"
                                                            data-error="#completion_status_error">
                                                            <option value="">{{$labels['select_completion_status']}}</option>
                                                            @foreach ($completion_status as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @selected(@$property->completion_status_id == $item->id ? true : false)>
                                                                    {{ $language_id != 1 && @$item->childdata[0]->completion_type ? $item->childdata[0]->completion_type : $item->completion_type }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <span id="completion_status_error" class="error-login"></span>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="add-property-field">
                                                    <div class="">
                                                        ...
                                                        <ul class="language">
                                                            @foreach ($amenities as $amenity)
                                                                <li
                                                                    class="{{ @$property->property_amenities_ids && in_array($amenity->id, explode(',', $property->property_amenities_ids)) ? 'checked1' : '' }}">
                                                                    <input type="checkbox" name="amenities[]"
                                                                        id="amenity{{ $amenity->id }}"
                                                                        class="input-hidden" data-error="#amenities_error"
                                                                        @checked(@$property->property_amenities_ids && in_array($amenity->id, explode(',', $property->property_amenities_ids)) ? true : false)
                                                                        value="{{ $amenity->id }}">
                                                                    <label class="eng-box"
                                            ...
                                            <div class="col-12">
                                                <div class="add-property-field">
                                                    ...
                                                    <div class="add-property-field-select">
                                                        <select name="area_id" id="area_id" data-error="#area_id_error"
                                                            value="{{ @$property->area_id ?: '' }}">
                                                            @foreach ($areas as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @selected(@$property->area_id == $item->id ? true : false)>
                                            ...
                                            <div class="col-md-6">
                                                <div class="add-property-field">
                                                    <div class="">
                                                        ...
                                                        <input type="hidden" name="property_latitude" id="property_latitude"
                                                            value="{{ @$property->property_address_latitude ?: '' }}">
                                                        <input type="hidden" name="property_longitude"
                                                            id="property_longitude" value="{{ @$property->property_address_longitude ?: '' }}">
                                                    </div>
                                                ...
                                                <div class="add-property-field add-property-field-img">
                                                    <div class="form-field" id="appendImages">
                                                        ...
                                                        <input type="file" class="form-control" id="uploadDoc"
                                                            accept="image/*" data-error="#uploadDoc_error"
                                                        ...
                                                        @if (@$property->propertyImages)
                                                            @foreach (@$property->propertyImages as $key => $image)
                                                                <div class="uploaded-img-box old-images">
                                                                    <img src="{{ asset('storage/property_images/' . $property->id . '/' . $image->property_image) }}"
                                                                        alt="" class="profile-image" />
                                                                    <span class="remove"
                                                                        onclick="removeOldimage(this);"
                                                                        data-propunique="{{ $image->id }}">
                                                                        <img src="{{ asset('assets/img/close.svg') }}"
                                                                            alt="" />
                                                                    </span>
                                                                    <input type="checkbox" name="is_deleted[]"
                                                                        id="property_image_{{ $image->id }}"
                                                                        value="{{ $image->id }}" style="display: none;">
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="add-property-btn">
                                                    <input type="hidden" name="property_slug"
                                                        value="{{ @$property->slug }}" id="property_slug">
                                                    <input type="hidden" name="is_edit" id="is_edit"
                                                        value="{{ @$property->id ? 1 : 0 }}">
                                                    <input type="submit" id="property_details_submit"
                                                        class="comman-btn"
                                                        value="{{ @$property ? $labels['save'] : $labels['next'] }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="#" name="select_plan" id="select_plan" enctype="multipart/form-data">
                                        <div class="row">
                                                                ...
                                                                <div class="form-check form-check-inline me-0 ps-0">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input" type="radio"
                                                                            ...
                                                                            {{ $is_checked ? 'checked' : ((@\Auth::guard('web')->user()->agent_type) ? 'disabled' : '') }}
                                                                            value="{{ $item['value'] }}"
                                                                            data-error="#agent_type_error">
                                                                        <span
                                                                            class="agent-type-name">{{ $labels[$item['label_key']] }}</span>
                                                                    </label>
                                                                </div>
                                            ...
                                            @php
                                                if (!@$userSubscription) {
                                                    $is_renew = 2;
                                                } elseif (@$userSubscription && $userSubscription->no_of_plan_post + $userSubscription->no_of_default_featured_post > $userSubscription->propertiesSubscribed->count()) {
                                                    $is_renew = 3;
                                                } else {
                                                    $is_renew = 1;
                                                }
                                            ...
                                            @if (@!$userSubscription)
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="subscription-btn">
                                                        <input type="button" id="add_property_submit"
                                                            class="comman-btn" value="{{ $labels['post_an_ad'] }}">
                                                    </div>
                                                </div>
                                            @else
                                                <input type="hidden" name="plan_id"
                                                    value="{{ $userSubscription->plan_id }}">
                                                {{-- if user have an active plan --}}
                                                <div class="col-12">
                                                    <div class="select-plan">
                                                        <div class="subscription-details">
                                                            @if ($userSubscription->no_of_plan_post + $userSubscription->no_of_default_featured_post <= $userSubscription->propertiesSubscribed->count())
                                                                ...
                                                                @if (!$userSubscription->is_free_plan)
                                                                    <input type="button" class="comman-btn"
                                                                        id="renew_plan_submit"
                                                                        data-price="{{ $userSubscription->subscriptionPlanDetails->plan_price ?: 0 }}"
                                                        ...
                                                        @if ($userSubscription->no_of_plan_post + $userSubscription->no_of_default_featured_post <= $userSubscription->propertiesSubscribed->count())
                                                            <p class="select-plan-heading">{{ $labels['select_plan'] }}
                                                            </p>
                                                            @foreach ($subscription_plans as $key => $value)
                                                                @if ($value->id == @$userSubscription->plan_id)
                                                                    @continue
                                                                @endif
                                                                <div class="subscription-plan-box-price"
                                                                    style="background-color : {{ $value->bg_color }}">
                                                                        ...
                                                                        <label class="form-check-label prime-plan"
                                                                            ...
                                                                            <div class="subscription-plan-name">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="subscription_plan"
                                                                                    data-price="{{ $value->plan_price }}"
                                                                                    id="subscriptionPlanRadio{{ $key }}"
                                                                                    value="{{ $value->id }}">
                                                                            </div>
                                                    ...
                                                    @endphp
                                                    <div class="subscription-btn">
                                                        <input type="button" id="subscription_btn" class="comman-btn"
                                        ...
                                        <input type="hidden" name="total_amount_transfer" id="total_amount_transfer"
                                            value="">
                                    </form>
                                </div>
                            </div>
...
@push('after-scripts')
    ...
    <script type="text/javascript"
        src="https://maps.google.com/maps/api/js?key={{ env('GOOGLE_MAPS_KEY', 'AIzaSyC3ksZwnrjrnMtiZXZJ7cx9YEckAlt3vh4') }}">
    </script>
    ...
    <script>
        ...
        $("#property_details").validate({
            ...
            messages: {
                ...
                condition: {
                    required: "{!! $labels['please_select_property_condition'] !!}",
                },
                completion_status: {
                    required: "{!! $labels['please_select_completion_status'] !!}",
                },
                'amenities[]': {
        ...
        function callPaymentGateway() {
            ...
            var is_renew = parseInt($("#is_renew").val());
            if ([1, 2].includes(is_renew)) {
                var total_amount;
