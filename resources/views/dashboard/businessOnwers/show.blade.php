...
@section('title', __('backend.view_businessowner'))
@push("after-styles")
    ...
    <div class="padding edit-package website-label-show">
        <div class="box">
            <div class="box-header dker">
                <h3>{{ __('backend.view_businessowner') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('businessOwners') }}">{{ __('backend.business_owner') }}</a> / 
                   <span>{{ __('backend.view_businessowner') }}</span>
                </small>
            </div>
            <div class="box-body">
                {{Form::open(['route'=>['businessOwners'],'method'=>'GET', 'files' => true,'enctype' => 'multipart/form-data' ])}}
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 form-control-label">
                           <label>{{$user->businessOwnerType->type_name}}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 form-control-label">
                           <label>{{urldecode($user->username)}}</label>
                        </div>
                    </div>
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2">
                        <a href="{{ route('businessOwners') }}" class="btn btn-default m-t" style="margin: 0 0 0 0px">
