...
@section('title', __('backend.editSubCategory'))
@push("after-styles")
        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.editSubCategory') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('categories') }}">{{ __('backend.subCategory') }}</a> / 
                    <span>{{ __('backend.editSubCategory') }}</span>

                </small>
            </div>
            <div class="box-body">
                {{Form::open(['route'=>['sub-category.update',$subcategory->id],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'userForm' ])}}
                {{ csrf_field() }}
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('name', old('name',urldecode($subcategory->name)), ['class' => 'form-control', 'id' => 'name', 'maxlength' => '100']) !!}
                                    ...
                                    <div class="col-sm-12 images">
                                        <div id="user_photo" class="col-sm-4 box p-a-xs">
                                            <a target="_blank" href="{{ $image_url . $subcategory->image }}"><img
                                                    src="{{ $image_url . $subcategory->image }}" class="img-responsive" style="width:200px; height:200px">
                                            </a>
                                            <br>
                                            <div class="delete">
                    ...
                    <div class="form-group row m-t-md">
                        <div class="offset-sm-2 col-sm-10">
                            ...
                            <a href="{{ route('sub-categories')}}" class="btn btn-default m-t">
