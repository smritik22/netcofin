...
@section('title', __('backend.subCategory'))
@section('content')
        ...
        <div class="box">
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('sub-category.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.addSubCategory') }}
                        </a>
                    </li>
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="program">
                    ...
                    <tbody>
                    @if(isset($subcategory_list) && count($subcategory_list) >0)
                        @foreach($subcategory_list as $type)
                                <tr>
                                    ...
                                    @if($type->image !="")
                                        <div>
                                            <img src="{{ asset('uploads/sub-category/'.$type->image) }}"
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm show-eyes list"
                                            href="{{ route('sub-category.show',['id'=>encrypt($type->id)]) }}" title="Show">
                                            
                                        </a>

                                        <a class="btn btn-sm success"
                                           href="{{ route("sub-category.edit",["id"=>encrypt($type->id)]) }}"
