...
@section('title', __('backend.modifiers'))
@section('content')
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.modifiers') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.modifiers') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('modifier.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.addmodifiers') }}
                        </a>
                    </li>
            ...
            {{ Form::open(['route' => 'modifier.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="program">
                    ...
                    <tbody>
                    @if(isset($modifier_list) && count($modifier_list) >0)
                        @foreach($modifier_list as $type)
                                <tr>
                                    ...
                                    @if($type->image !="")
                                        <div>
                                            <img src="{{ asset('uploads/modifier/'.$type->image) }}"
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm show-eyes list"
                                            href="{{ route('modifier.show',['id'=>encrypt($type->id)]) }}" title="Show">
                                            
                                        </a>

                                        <a class="btn btn-sm success"
                                           href="{{ route("modifier.edit",["id"=>encrypt($type->id)]) }}"
