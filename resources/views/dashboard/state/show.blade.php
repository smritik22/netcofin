...
@section('title', __('backend.view_state'))
@push("after-styles")
    ...
    <div class="padding edit-package website-label-show">
        <div class="box">
            <div class="box-header dker">
                ...
                <h3>{{ __('backend.view_state') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                   <a href="{{ route('state') }}">{{ __('backend.state') }}</a> /
                   <span>{{ __('backend.view_state') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 form-control-label">
                           <label>{{$state->country->name}}</label>
                        </div>
                    </div>
