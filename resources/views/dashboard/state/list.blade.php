...
@section('title', __('backend.state'))
@section('content')
<style>
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.state') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.state') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('state.create') }}">
            ...
            {{ Form::open(['route' => 'state.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm show-eyes list"
                                                    href="{{ route('state.show',['id'=>encrypt($type->id)]) }}" title="Show">
                                                    
                                                </a>

                                                <a class="btn btn-sm success"
                                                href="{{ route("state.edit",["id"=>encrypt($type->id)]) }}"
                                        ...
                                        <div class="modal-dialog" id="animate">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('state.delete',['id'=>$type->id]) }}"
