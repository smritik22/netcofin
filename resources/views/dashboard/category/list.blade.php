    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.category') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.category') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                    ...
                    @if(isset($category_list) && count($category_list) >0)
                        @foreach($category_list as $type)
                                <tr>
                                    ...
                                    @if($type->image !="")
                                        <div>
                                            <img src="{{ asset('uploads/category/'.$type->image) }}"
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm show-eyes list"
                                            href="{{ route('category.show',['id'=>encrypt($type->id)]) }}" title="Show">
                                            
                                        </a>

                                        <a class="btn btn-sm success"
                                           href="{{ route("category.edit",["id"=>encrypt($type->id)]) }}"
