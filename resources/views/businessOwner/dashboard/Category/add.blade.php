...
<div class="right-content">
    <div class="right-content-box">
        ...
        <div class="right-content-box-bottom add-category">
            <div class="view-order-top-bar">
                <h4>Create New Category</h4>
            </div>
            <form action="{{route("category.store")}}" enctype = "multipart/form-data" method="POST" id= "categoryForm" >
                {{ csrf_field() }}
            {{-- {{Form::open(['route'=>['category.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'categoryForm' ])}} --}}
                <div class="row">
                    <div class="col-12">
                        <div class="add-category-img">
                            <div class="yes">
                                ...
                                <img id="ImgPreview" src="" class="preview1" data-pagespeed-url-hash="2322264633" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" >
