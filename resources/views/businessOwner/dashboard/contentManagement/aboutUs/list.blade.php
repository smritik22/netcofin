...
<div class="right-content">
				...
				<div class="right-content-box home-content-box">
				@include('businessOwner.dashboard.layouts.header_with_login')
					...
					<div class="bulid-form-outer">
						<form>
							<h2 class="section-headding"><span>About US Information</span></h2>
							<div class="right-content-wrapper banner-information">
								<div class="row">
									<div class="col-md-6">
										<div class="right-input">
											<div class="floating-label">      
												<input type="text" class="floating-input form-control edit_icon" value="About Us" placeholder=" " required >
												<span class="highlight"></span>
												<label>Title</label>
											</div>
										</div>
										<div class="floating-label textarea">      
											<textarea class="floating-input form-control edit_icon mb-0" placeholder=" ">I'm a paragraph. I’m a great place for you to tell a story know little more. I'm a paragraph. I’m a great place for you to tell a story know little more. I'm a paragraph. I’m a great place for you to tell a story know little more. I'm a paragraph. I’m a great place for you to tell a story know little more.</textarea>
											<span class="highlight"></span> 
