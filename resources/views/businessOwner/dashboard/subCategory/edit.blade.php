				...
				<div class="right-content-box">
                    ...
                    <div class="right-content-box-bottom">
                        ...
                        {{-- <form action="{{route('sub-category.update',$subcategory->id)}}"  method="POST" id= "subCategoryForm" > --}}
                            {{Form::open(['route'=>['sub-category.update',$subcategory->id],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'subCategoryForm' ])}}
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class=" floating-label">
                                        <select name="category_id" class="form-select floating-select form-control">
                                        @foreach ($categories as $key => $value )
                                            <option value="{{$value->id}}" {{old('categories_id', $subcategory->category_id) == $value->id? "selected" : "" }}>{{$value->name}}</option>
                                        @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="floating-label">      
                                        <input class="floating-input form-control edit_icon" type="text"  placeholder=" " name="name" value="{{$subcategory->name}}">
                                        <span class="highlight"></span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="floating-label">      
                                        <input class="floating-input form-control" type="text" placeholder=" " name="tax" value="{{$subcategory->tax}}">
                                        <span class="highlight"></span>
                                        <label>Tax</label>
                                    </div>
                                    @if ($errors->has('tax'))
