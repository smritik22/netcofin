    ...
    <div class="right-content">
        ...
        @include('businessOwner.dashboard.layouts.header_with_login')
            <div class="right-content-box2">
                <div class="row">
                    <div class="col-12">
                        <div class="section-headding-box sub_pages_box back-to-page menu-main-heading">
                            <h1 class="section-headding mb-0">Sub Category</h1>
                            <a class="comman-btn" href="{{route('sub-category.create')}}">
                ...
                <div class="new-order-tabel-outer ">
                                            ...
                                            <div class="">
                                                <table class="table student-list-table program-manage" id="general_users">
                                                    <thead>
                                                            ...
                                                            <select name="order_status_check" id="order_status_check" class="form-control">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="sorting"><p>&#9650;&#9660;{{ __('backend.category') }}</p></th>
                                                            <th><p>&#9650;&#9660;{{ __('backend.subCategory') }}</p></th>
...
<script type="text/javascript">
        ...
        function load_data() {
            ...
            $('#general_users').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                            return $.extend({}, d, {
                                "category_name": $("#order_status_check").val().toLowerCase(),
    ...
    function ajaxUpdateAll(csrf, join_selected_values, type) {
        ...
        $.ajax({
            url: "{{ route('sub-category.updateAll') }}",
            type: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrf
            },
