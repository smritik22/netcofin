...
class Helper
{
    ...
    static function getEmailTemplateData($language_id, $id){
        if($language_id == 1){
    ...
    static function getEmailtemplateContentForgotpassword($id, $email = "", $password = "", $name = "", $url = "", $logo = "")
    {
        ...
        $emailtemp = Helper::getEmailTemplateData(1,2);
    ...
    static function getFeatuerdAddonsDuration($start_date, $amount = 0, $type){
        $end_date = \Carbon\Carbon::parse($start_date);
        $label_key = "";
        if($type == 1)
        {
        ...
        $label_val = Helper::getLabelValueByKey($label_key);
        $print = $amount . ' ' . Helper::getLabelValueByKey($label_val);

        return array("enddate" => $end_date, "value" => $amount, "label_value" => $label_val, "print" => $print);
    }

    static function getWebsiteDetails() {
        $WebmasterSetting = WebmasterSetting::find(1);
        return @$WebmasterSetting;
    }
