...
class DashboardController extends Controller
{
    ...
    public function plan_list() {
        ...
        return view('frontEnd.subscription.subscription_plans_list', compact('language_id', 'labels', 'PageTitle', 'PageDescription', 'PageKeywords', 'WebmasterSettings', 'subscription_plans'));
    }
