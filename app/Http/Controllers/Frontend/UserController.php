...
class UserController extends Controller
{
    ...
    public function login(Request $request) {
        ...
        $user = MainUsers::where('is_otp_varified', '=', 1)->where('mobile_number', '=', $request->mobile_number)->latest('id');
		if (@$user->exists()) {
            ...
            if (auth()->guard('web')->attempt(['mobile_number' => $request->input('mobile_number'), 'password' => $request->input('password'), 'is_otp_varified' => 1])) {
    ...
    public function getFavourites(Request $request) {
        ...
        $html = view('frontEnd.users.profile.favourites', compact('properties', 'labels', 'language_id', 'user_id', 'pagination_data'))->render();
