...
class RevenueReportController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        fputcsv($file, array('Transaction ID', 'Subscription Type' , 'Username', 'Mobile number', 'Amount', 'Date Transferred', 'Status'));
        ...
        foreach ($transactions as $key => $data) {
            ...
            fputcsv($file, array( $transaction_id, " ", @urldecode($agent_name), $agent_contact, $amount, $date, $status ));
    ...
    public function anyData(Request $request){
        ...
        foreach ($totalAr as $key => $data) {
            ...
            $data_arr[] = array(
                ...
                "user_name" => @urldecode($data->agentDetails->full_name)?:"",
                "user_contact" => @urldecode($data->agentDetails->country_code) . ' ' . @$data->agentDetails->mobile_number,
                "amount" => @$data->amount?$data->amount . ' ' . $currency : "-",
