...
class GeneralUsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $main_user->mobile_number = @$request->mobile_number?:"";
        $main_user->user_type = "2";
        $main_user->business_type_id = 1;
        ...
        return redirect()->route('generalusers')->with('success', __('backend.addDone'));
    }
    ...
    public function create()
    {
        ...
        // dd(Helper::convert(2));
        return view("dashboard.general_users.create");
    }
    /**
    ...
    public function validateRequest($request,$id="",$lang_id = "",$childId="")
    {
        $validation_messages = [
            ...
            'full_name.max' => 'Full name accept more than 30 characters',
        ...
        if( $id !="" )
        {
            $validator = Validator::make($request->all(), [
                ...
                'email' => [
                            ...
                            'unique:users,email,'.$id.',id,status,2',
                        ],
                'country_code' => [
                                    'required'
                                ],
    ...
    public function updateAll(Request $request)
    {
        ...
        if ($request->ids != "") {
            ...
            return redirect()->route('generalusers')->with('errorMessage',__('backend.select_row'));
        }
