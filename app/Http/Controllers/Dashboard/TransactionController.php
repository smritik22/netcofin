...
class TransactionController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $filename = 'transaction_report_' . date('d/m/Y') . '.csv';
    ...
    public function anyData(Request $request)
    {
        ...
        $totalAr = Transaction::select('transactions.*','agent.full_name as agent_name','agent.country_code', 'agent.mobile_number')
