...
class UsersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($User)) {
            ...
            if ($request->$formFileName != "") {
                $fileFinalName_ar = time() . rand(1111,
                        9999) . '.' . $request->file($formFileName)->getClientOriginalExtension();
                $uploadPath = public_path()."/uploads/contacts/";
                // dd($uploadPath);
            ...
            if ($request->photo_delete == 1) {
                ...
                if ($User->profile_photo != "") {
                    File::delete($this->getUploadPath() . $User->profile_photo);
                }
            ...
            if ($fileFinalName_ar != "") {
                ...
                $User->profile_photo = $fileFinalName_ar;
            }
    ...
    public function updatePassword(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            [
            'password_confirmation.confirmed' => 'The new-password and confirm new-password field does not match.'
            ]);
