    ...
    */
    ...
    public function add_property(Request $request)
    {
        ...
        if ($addProperty->save()) {
            ...
            $user_email = urldecode($user->email);
            $full_name = urldecode($user->full_name);
            $mobile_number = $user->mobile_number;
            $country_code = urldecode($user->country_code);
            $template_id = 11;
            ...
            $propertyDetails['property_price'] = (string) number_format($fetchProperty->base_price, 3) ?: "";
    ...
    */
    ...
    public function property_details(Request $request)
    {
        ...
        if ($property) {
            ...
            $response['property_price'] = (string) (number_format((@$property->price_area_wise ?: 0) ,3)) . " " . $currency;
